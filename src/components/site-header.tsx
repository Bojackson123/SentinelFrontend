...
export function SiteHeader() {
  ...
  return (
    <div>
    <header className="flex h-[48px] shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
